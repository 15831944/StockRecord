...
class CCridCtrlMemDC : public CDC
{
public:

    // constructor sets up the memory DC
    CCridCtrlMemDC(CDC* pDC) : CDC()
    {
        ASSERT(pDC != NULL);
    ...
    CCridCtrlMemDC* operator->() {return this;}
        
    // Allow usage as a pointer
    operator CCridCtrlMemDC*() {return this;}

private:
    CBitmap  m_bitmap;      // Offscreen bitmap
    CBitmap* m_pOldBitmap;  // bitmap originally found in CCridCtrlMemDC
